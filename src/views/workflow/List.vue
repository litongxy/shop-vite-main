<template>
  <div class="comprehensive-table-container auto-height-container">
    ...
    <el-table ref="tableRef" v-loading="listLoading" border :data="list" @selection-change="setSelectRows">
      ...
      <el-table-column align="center" label="名称" min-width="200" prop="name" />
...
import { getWorklflowList } from '/@/api/workflow.ts'
...
const fetchData = async () => {
  ...
  const { data } = await getWorklflowList(queryForm)
  console.log( data )
