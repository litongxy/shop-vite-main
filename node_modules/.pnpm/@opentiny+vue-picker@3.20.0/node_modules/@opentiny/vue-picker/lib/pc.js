...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [_ctx.shape === "filter" ? withDirectives((openBlock(), createBlock(_component_tiny_filter_box, {
      ...
      key: "0"
    } : void 0]), 1040, ["tabindex", "class", "readonly", "disabled", "size", "name", "placeholder", "onFocus", "onKeydown", "model-value", "title", "display-only", "display-only-content", "onInput", "onChange", "onMouseenter"])), [[_directive_clickoutside, _ctx.handleClose, void 0, {
      mousedown: true
      ...
      mousedown: true
    }]]), (openBlock(), createBlock(resolveDynamicComponent(_ctx.state.panel), {
      step: _ctx.step,
      ...
      _: 3
      /* FORWARDED */
    }, 40, ["step", "show-week-number", "time-editable", "format-weeks", "now-click", "visible", "onPick", "onSelectRange", "onSelectChange"]))],
    512
    /* NEED_PATCH */
  );
}
