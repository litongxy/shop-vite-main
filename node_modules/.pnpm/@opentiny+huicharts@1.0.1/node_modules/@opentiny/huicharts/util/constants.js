...
var TOKENCHARTNAMES = ['AssembleBubbleChart', 'BarChart', 'BoxplotChart', 'BubbleChart', 'CandlestickChart', 'CircleProcessChart', 'FunnelChart', 'GaugeChart', 'HeatMapChart', 'HillChart', 'JadeJueChart', 'LineChart', 'AreaChart', 'LiquidfillChart', 'PieChart', 'PolarBarChart', 'ProcessChart', 'RadarChart', 'RegionChart', 'SankeyChart', 'SunburstChart', 'TreeChart', 'WaveChart', 'WordCloudChart', 'TimelineChart', 'ChartCard', 'BulletChart'];

// 默认主题
var DEFAULT_THEME_NAME = THEMES.LIGHT;
...
var ADAPTIVE_THEME = ['hdesign-light', 'hdesign-dark', 'bpit-light', 'bpit-dark'];
export { ADAPTIVE_THEME, CHART_TYPE, CURRENT_THEME, DEFAULT_THEME_NAME, THEMES, THEME_ERROR_TIP_MESSAGE, TOKENCHARTNAMES };
