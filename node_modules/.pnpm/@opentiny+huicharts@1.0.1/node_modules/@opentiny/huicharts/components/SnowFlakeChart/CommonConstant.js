...
var textStyle = function textStyle(theme) {
  return {
    ...
    unitStyle: theme.indexOf('dark') !== -1 ? '#bbbbbb' : '#999',
    // 单位字体颜色
...
// 默认信号强度文本色
var singlecolor = '#36C18D';
// warning信号强度文本色
var singleWarnColor = '#f43146';
...
export { direction, interval, opacity, radioType, singleMax, singleMin2G, singleMin5G, singleWarnColor, singlecolor, tagPosition, textStyle };
