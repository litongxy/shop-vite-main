...
//  阈值线雷达图红点基础series配置
function handleRedPointerSeries(index, dataValue, seriesName, isgradient) {
  if (isgradient === void 0) {
    isgradient = false;
  }
...
export { getRadar as default, getMarkRadarOption, getRedPointerRadar, getSeriesUnit, getThresholdSeries, handleRedPointerSeries };
