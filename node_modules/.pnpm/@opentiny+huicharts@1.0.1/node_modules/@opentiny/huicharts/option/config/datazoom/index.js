...
function datazoom(iChartOption) {
  ...
  var show = self.show,
    ...
    style = self.style,
    zoomOnMouseWheel = self.zoomOnMouseWheel,
    height = self.height;
  if (show) {
    ...
    // 用户自定义样式
    if (style) {
      var _dataZoom$ = dataZoom[0],
        backgroundColor = _dataZoom$.backgroundColor,
        dataBackground = _dataZoom$.dataBackground,
        selectedDataBackground = _dataZoom$.selectedDataBackground,
        fillerColor = _dataZoom$.fillerColor;
