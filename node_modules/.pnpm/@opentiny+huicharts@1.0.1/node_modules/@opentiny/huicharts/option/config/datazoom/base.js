...
function getBaseOption() {
  return [{
    ...
    xAxisIndex: [0],
    zoomLock: false,
    borderColor: Theme.config.dataZoomBackgroundColor,
    // 边框
    borderRadius: 0,
    backgroundColor: Theme.config.dataZoomBackgroundColor,
    // 背景颜色
    fillerColor: codeToRGB(Theme.config.colorState.colorInfo, 0.1),
    // 选中范围填充颜色
    handleSize: '68%',
    // 控制手柄的尺寸
    handleIcon: 'path://M0 0 L5 0 L5 12 L0 12 L0 0 Z',
    // 手柄形状
    showDetail: false,
    handleStyle: {
      color: Theme.config.dataZoomHandleColor,
      // 手柄颜色
      shadowBlur: 12,
      // 阴影模糊大小
      ...
      opacity: 1,
      // 透明度
      borderColor: Theme.config.dataZoomHandleBorderColor,
      // 手柄边框颜色
      borderWidth: 6,
      // 手柄边框宽度
    ...
    dataBackground: {
      lineStyle: {
        color: Theme.config.dataBackgroundLineColor,
        // 线条颜色
        join: 'round',
        cap: 'round'
      },
