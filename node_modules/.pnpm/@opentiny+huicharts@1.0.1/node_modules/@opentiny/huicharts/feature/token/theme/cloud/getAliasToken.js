...
function getAliasToken(globalToken, light) {
  if (light === void 0) {
    light = true;
  }
  var colorGray0 = globalToken.colorGray0,
    colorGray5 = globalToken.colorGray5,
    colorGray30 = globalToken.colorGray30,
    colorGray40 = globalToken.colorGray40,
    ...
    fontSizeBase = globalToken.fontSizeBase,
  ...
  return {
    ...
    // symbol等填充颜色
    colorFillSecondary: light ? colorGray0 : colorGray90,
    // 确定
    // 主要文本色
    colorTextPrimary: light ? colorGray90 : colorGray40,
    // 确定
    // 次级文本色
    colorTextSecondary: light ? colorGray60 : colorGray50,
    // 确定
    // 三级文本色
    colorTextTertiary: light ? colorGray60 : colorGray50,
    // 确定
    // 禁用文本色
    colorTextDisabled: light ? colorGray50 : colorGray60,
    // 确定
    // 图标激活色（legend翻页的颜色）
    colorIconPrimary: light ? colorGray60 : colorGray60,
    // 确定
    // 控件失效色（legend失效的颜色）
    colorInactive: light ? colorGray50 : colorGray80,
    // 确定
    // 图标禁用色（legend翻页图标禁用的颜色）
    colorIconDisabled: light ? colorGray50 : colorGray80,
    // 确定
    // 坐标轴线颜色
    colorAxisLine: light ? colorGray30 : colorGray80,
    // 确定
    // 用于极坐标的径向轴和雷达坐标的分隔线颜色，和坐标轴线颜色保持一致，特殊处理专用
    colorAxisLineSecondary: light ? colorGray30 : colorGray80,
    // 确定
    // 刻度线颜色
    colorAxisTickLine: light ? colorGray30 : colorGray80,
    // 确定
    // 分隔线颜色
    colorAxisSplitLine: light ? colorGray30 : colorGray80,
    // 确定
    // 坐标轴指示器悬浮线
    colorAxisPointerLine: light ? colorGray60 : colorGray70,
    // 确定
    // 透明边框色
    ...
    // 确定
    // 边框反选色
    colorBorderInverse: light ? colorGray90 : colorGray0,
    // 确定
    // datazoom手柄边框色 把手容器色
    colorBorderSecondary: light ? colorGray0 : colorGray60,
    // 禁用边框颜色和图表colorBgPrimary保持一致（聚合气泡图用todo）
    colorBorderDisabled: light ? colorGray0 : colorGray90,
    // 确定
    // label颜色
    colorLabel: light ? colorGray90 : colorGray40,
    // 确定
    // label禁用颜色（和文本禁用色保持一致）
    colorLabelDisabled: light ? colorGray50 : colorGray60,
    // 确定
    // 虚线的颜色
    ...
    // 无数据占位背景
    colorBgEmpty: light ? colorGray30 : colorGray80,
    // 确定
    // labelLine颜色
    colorLabelLine: light ? colorGray90 : colorGray40,
    // 确定
    // 线透明
...
export { getAliasToken as default, getAliasToken as getCloudAliasToken };
