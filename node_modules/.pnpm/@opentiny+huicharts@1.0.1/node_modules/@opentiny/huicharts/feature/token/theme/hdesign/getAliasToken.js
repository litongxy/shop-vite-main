...
function getAliasToken(globalToken, light) {
  ...
  var colorGray0 = globalToken.colorGray0,
    ...
    borderRadiusLg = globalToken.borderRadiusLg;
  return {
    //  初级底色  图表背景
    ...
    // 禁用文本色
    colorTextDisabled: light ? colorGray20 : colorGray60,
    // 确定
    // 图标激活色（legend翻页的颜色）
    colorIconPrimary: light ? colorGray70 : colorGray20,
    // 确定
    // 控件失效色（legend失效的颜色）
    colorInactive: light ? colorGray10 : colorGray80,
    // 确定
    // 图标禁用色（legend翻页图标禁用的颜色）
    colorIconDisabled: light ? colorGray10 : colorGray80,
    // 确定
    // 坐标轴线颜色
    colorAxisLine: light ? colorGray10 : colorGray70,
    // 确定
    // 用于极坐标的径向轴和雷达坐标的分隔线颜色，和坐标轴线颜色保持一致，特殊处理专用
    colorAxisLineSecondary: light ? colorGray10 : colorGray70,
    // 确定
    // 刻度线颜色
    colorAxisTickLine: light ? colorGray10 : colorGray70,
    // 确定
    // 分隔线颜色
    colorAxisSplitLine: light ? colorGray5 : colorGray80,
    // 确定
    // 坐标轴指示器悬浮线
    colorAxisPointerLine: light ? colorGray10 : colorGray70,
    // 确定
    // 透明边框色
    ...
    // 指示器阴影
    colorAxisPointerShadow: light ? codeToRGB(colorGray10, 0.5) : codeToRGB(colorGray5, 0.05),
    // 确定
    // tip阴影
    colorShadow: light ? codeToRGB(colorGray90, 0.08) : codeToRGB(colorGray100, 0.5),
    // 确定
    // datazoom手柄阴影
...
export { getAliasToken as default, getAliasToken as getHdesignAliasToken };
