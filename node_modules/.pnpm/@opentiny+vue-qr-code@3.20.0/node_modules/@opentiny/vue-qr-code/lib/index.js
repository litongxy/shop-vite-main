...
import '@opentiny/vue-theme/qr-code/index.css';
import { openBlock, createElementBlock, normalizeClass, normalizeStyle, createElementVNode, createCommentVNode } from 'vue';
...
var browser = {};
var canPromise$1 = function canPromise$12() {
  ...
  props: {
    ...
    level: {
      ...
      validator: function validator(value) {
        return ["Low", "Medium", "Quality", "High"].includes(value);
      }
    },
    size: {
      type: Number,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    {
      ref: "wrapperRef",
      class: normalizeClass(["tiny-qr-code-container", _ctx.bordered ? "border" : ""]),
      style: normalizeStyle({
        width: _ctx.state.sizeStr,
        height: _ctx.state.sizeStr
      })
    },
    [createElementVNode(
      "canvas",
      ...
      512
      /* NEED_PATCH */
    ), _ctx.icon ? (openBlock(), createElementBlock("div", _hoisted_2, [createElementVNode("img", {
      src: _ctx.icon,
      style: normalizeStyle({
        width: _ctx.state.iconSizeStr,
        height: _ctx.state.iconSizeStr,
        background: _ctx.state.iconBackgroudColor
      }),
      class: "icon"
    }, null, 12, _hoisted_3)])) : createCommentVNode("v-if", true)],
    6
    /* CLASS, STYLE */
  );
}
