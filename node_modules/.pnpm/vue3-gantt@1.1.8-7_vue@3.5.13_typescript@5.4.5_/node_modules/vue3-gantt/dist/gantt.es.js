...
const Gantt_vue_vue_type_style_index_0_scoped_b9f77374_lang = "";
...
const _sfc_main = {
  ...
  setup(__props, { expose, emit }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "a5e82f3c": props.borderColor,
      "7527dfcf": props.itemWidth + "px",
      "7a5c76be": props.itemHeight + "px",
      "32661602": ganttMaxWidth.value,
      "285d8fc0": ganttInnerHeight.value
    }));
    let rangeDate = ref([]);
...
const Gantt = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b9f77374"]]);
export {
  computedDaysRange,
  Gantt as default,
  fetchDayDetail,
