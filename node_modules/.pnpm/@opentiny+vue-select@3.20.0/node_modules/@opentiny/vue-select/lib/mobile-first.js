...
var _hoisted_6 = ["disabled", "autocomplete"];
var _hoisted_7 = {
  key: 1
};
var _hoisted_8 = {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock(
    ...
    [createElementVNode("div", {
      ...
      key: "0"
    } : void 0]), 1032, ["modelValue", "placeholder", "name", "id", "autocomplete", "size", "disabled", "readonly", "display-only", "display-only-content", "unselectable", "tabindex", "show-empty-value", "onFocus", "onBlur", "onKeyup", "onKeydown", "onPaste", "onMouseenter", "onMouseleave", "onCompositionend"])) : createCommentVNode("v-if", true), createVNode(Transition, {
      ...
      default: withCtx(function() {
        return [withDirectives(createVNode(_component_tiny_select_dropdown, {
          ...
          _: 3
          /* FORWARDED */
        }, 8, ["title", "close-by-mask", "search-placeholder", "is-drop-inherit-width", "placement", "append-to-body", "style", "popper-options", "class", "height"]), [[vShow, !_ctx.onCopying() && !_ctx.hideDrop && _ctx.state.visible && _ctx.state.emptyText !== false]])];
      }),
      _: 3
      /* FORWARDED */
