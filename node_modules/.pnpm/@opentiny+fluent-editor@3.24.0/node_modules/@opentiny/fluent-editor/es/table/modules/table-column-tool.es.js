...
import { COL_TOOL_HEIGHT, ROW_TOOL_WIDTH, CELL_MIN_HEIGHT, PRIMARY_COLOR, CELL_MIN_WIDTH } from "../table-config.es.js";
  ...
  addRowCellHolderHandler(cell) {
    ...
    const handleMouseup = (e) => {
      ...
      if (dragging) {
        ...
        if (hasContentTd) {
          tds.forEach((td) => td.getAttribute("rowspan") === "1" && css(td, { height: tdHeight }));
...
export {
  TableColumnTool as default
};
//# sourceMappingURL=table-column-tool.es.js.map
